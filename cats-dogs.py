...
train_files_path = '/home/nihira/tensorflow/catsvsdogs/train/'
test_files_path = '/home/nihira/tensorflow/catsvsdogs/test/'
...
model = tflearn.DNN(network, checkpoint_path='model_cat_dog_6.tflearn', max_checkpoints = 3,
                    tensorboard_verbose = 3, tensorboard_dir='tmp/tflearn_logs_new/')
